...
public class StreamTest {
    ...
    @Test
    public void shouldCollectToString2(){
        List<String> extrasCodes = ImmutableList.of("1", "2", "3", "4", "5");
        ArrayOfextrasCodesItemString arrayOfextrasCodesItemString1 = new ArrayOfextrasCodesItemString();
//        for (String extraCode : extrasCodes) {
//            arrayOfextrasCodesItemString1.getExtrasCodesItem().add(extraCode);
//        }

//        extrasCodes.stream()
//                .collect(Collectors.toCollection(() -> arrayOfextrasCodesItemString1.getExtrasCodesItem()));

        //System.out.println(new ArrayOfextrasCodesItemString().getExtrasCodesItem().addAll(extrasCodes));

        System.out.println(arrayOfextrasCodesItemString1.getExtrasCodesItem().get(3));
...
class ArrayOfextrasCodesItemString {
    protected List<String> extrasCodesItem;

    public ArrayOfextrasCodesItemString() {
    }

    public List<String> getExtrasCodesItem() {
        if(this.extrasCodesItem == null) {
            this.extrasCodesItem = new ArrayList();
        }
